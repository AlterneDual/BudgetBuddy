...
public final class ActivityMenuLateral2Binding implements ViewBinding {
  @NonNull
  ...
  private ActivityMenuLateral2Binding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ActivityMenuLateral2Binding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityMenuLateral2Binding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_menu_lateral_2, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityMenuLateral2Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMenuLateral2Binding((ConstraintLayout) rootView, btnCerrar, frameLayout2,
