...
public final class CustomListAjustesBinding implements ViewBinding {
  @NonNull
  ...
  private CustomListAjustesBinding(@NonNull LinearLayout rootView, @NonNull LinearLayout customList,
  ...
  @NonNull
  public static CustomListAjustesBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static CustomListAjustesBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.custom_list_ajustes, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static CustomListAjustesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new CustomListAjustesBinding((LinearLayout) rootView, customList, imgLayout, ivIcono,
          tvNombre1, tvNombre2);
    }
