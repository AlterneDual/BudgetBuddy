...
public final class MgAnadirGasto extends androidx.appcompat.app.AppCompatActivity {
    ...
    private android.view.View vistaActual;
    ...
    public final void setCategoriaAtributo(@org.jetbrains.annotations.NotNull
    models.Categoria p0) {
    }
    ...
    @androidx.annotation.RequiresApi(value = android.os.Build.VERSION_CODES.N)
    @android.annotation.SuppressLint(value = {"NewApi", "ResourceAsColor"})
    @java.lang.Override
